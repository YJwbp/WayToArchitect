...
![img](https:////upload-images.jianshu.io/upload_images/944365-e7baca065f885271.png)
...
>
> ![img](https:////upload-images.jianshu.io/upload_images/944365-79b1e86793514e99.png)
>
> 事件列
...
![img](https:////upload-images.jianshu.io/upload_images/944365-ece40d4524784ffa.png)

UI界面

![img](https:////upload-images.jianshu.io/upload_images/944365-02c588300f6ad741.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-7fee82bba19a3821.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-7c6642f518ffa3d2.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-d0a7e6f3c2bbefcc.png)
...
<img src="https:////upload-images.jianshu.io/upload_images/944365-2064dcb69200fc6d.png" alt="img" style="zoom:50%;" />
...
/**
  ...
  * 作用：如果想知道用户跟设备的交互事件（key、touch、trackball）
  * 注：
  *    a. 该方法为空方法
  *    b. 当此activity在栈顶时，触屏点击、按home，back，menu键等都会触发此方法
  */
...
![img](https:////upload-images.jianshu.io/upload_images/944365-f8fda76bbdad7b96.png)

示意图

- 方法总结

![img](https:////upload-images.jianshu.io/upload_images/944365-e186b0edcb590546.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-6ec2e864af7ffd37.png)

示意图

- 核心方法总结

![img](https:////upload-images.jianshu.io/upload_images/944365-ff627fea1a2244ad.png)
...
- 布局如下
  ...
  ![img](https:////upload-images.jianshu.io/upload_images/944365-b0bf3dd7ad41b335.png)
...
- 结果测试
  ...
  ![img](https:////upload-images.jianshu.io/upload_images/944365-a9c45aa25d12b589.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-76ce9e8299386729.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-762cf45f36858bbd.png)
...
- 测试结果
  ...
  ![img](https:////upload-images.jianshu.io/upload_images/944365-97959093583369a0.png)

  示意图

# 2.4 总结

<img src="https:////upload-images.jianshu.io/upload_images/944365-eeebede55f55b040.png" alt="img"  />
...
![img](https:////upload-images.jianshu.io/upload_images/944365-bccafd3ff8a880ff.png)

示意图

- 以方法为核心的图解说明

![img](https:////upload-images.jianshu.io/upload_images/944365-9f340a39bdad520e.png)
...
- 已知事件分发过程的核心方法为：`dispatchTouchEvent()`、`onInterceptTouchEvent()` 和 `onTouchEvent()`
  ...
  ![img](https:////upload-images.jianshu.io/upload_images/944365-faaf73d0f3eb870f.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-4fbf11afa24b033b.png)

示意图

![img](https:////upload-images.jianshu.io/upload_images/944365-f8888a622c255648.png)
...
![img](https:////upload-images.jianshu.io/upload_images/944365-a4582905b3972904.png)

示意图



![img](https:////upload-images.jianshu.io/upload_images/944365-fee3555bdc6f9524.png)
